...
namespace AutomaticTestingSystem.Framework.CommandBehaviors 
{
    ...
    public class CommandBehavior :Behavior<FrameworkElement>
    {
        ...
        /// </summary>
        public static bool GetCommandParameter(DependencyObject d)
        {
        ...
        #region PassEventArgs
        /// <summary>
        /// PassEventArgs Attached Dependency Property
        /// </summary>
        public static readonly DependencyProperty PassEventArgsProperty = 
            DependencyProperty.RegisterAttached("PassEventArgs", typeof(bool), typeof(CommandBehavior), 
                new FrameworkPropertyMetadata(false,
                    new PropertyChangedCallback(OnPassEventArgsChanged)));

        /// <summary>
        /// Gets the PassEventArgs property.  
        /// </summary>
        public static bool GetPassEventArgs(DependencyObject d)
        {
            return (bool)d.GetValue(PassEventArgsProperty);
        }
        /// <summary>
        /// Sets the PassEventArgs property. 
        /// </summary>
        public static void SetPassEventArgs(DependencyObject d, object value)
        {
            d.SetValue(PassEventArgsProperty, value);
        }
        /// <summary>
        /// Handles changes to the PassEventArgs property.
        /// </summary>
        private static void OnPassEventArgsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            CommandBehaviorBinding binding = FetchOrCreateBinding(d);
            binding.PassEventArgs = (bool) e.NewValue;
        }
        #endregion
